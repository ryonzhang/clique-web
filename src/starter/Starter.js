    ...
    return (
        <React.Fragment>
            <main className={classes.layout} >
                ...
                <div className={classes.font}>Grow business with CliquePass</div>
                <div className={classes.text}>We aim to build a community for children to explore and grow their talents

                    Very often, we as parents are unsure about our children’s strength and weaknesses. Clique pledge to help parents identify your children’s forte by connecting them to different activities at a minimum cost!

                    Join us in the journey and list your unsold class spots with us to maximize your revenue
                </div>
